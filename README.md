...
- [APIMesh](https://github.com/mbeato/conway) - 100 pay-per-call APIs for AI agents (http-status-checker, favicon-checker, microservice-health-check, status-code-checker, regex-builder, user-agent-analyzer, +94 more). Supports x402 + MPP.
